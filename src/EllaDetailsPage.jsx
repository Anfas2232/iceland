...
const Slideshow = ({ slides }) => {
  ...
  return (
    <div id="EllCarousel" className="carousel slide carousel-fade mb-5">
...
const EllaDetailsPage = () => {
  ...
  const attractions = [
     { title: 'How to Spend One Day in Ella', image: museum, description: 'Discover history and heritage.' },
    { title: 'Nine Arches Bridge', image: tower, description: 'An ancient stupa, one of the oldest in Sri Lanka.' },
    { title: 'Diyaluma Falls', image: hospital, description: 'A vast monastery complex and one of the largest stupas.' },
   { title: 'Ella Rock', image: seema, description: 'Hike to breathtaking views.' },
    { title: 'Ravana Falls', image: Red_Mosque, description: 'Iconic railway bridge amidst greenery.' },
    { title: 'Tea Plantations', image: portcity, description: 'Explore scenic tea estates and factories.' },
  ];
