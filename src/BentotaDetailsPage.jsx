...
const Slideshow = ({ slides }) => {
  ...
  return (
    <div id="BentotaCarousel" className="carousel slide carousel-fade mb-5">
...
const BentotaDetailsPage = () => {
  ...
  const attractions = [
    { title: 'Bentota Lake', image: museum, description: 'Discover history and heritage.' },
    { title: 'Brief Garden', image: tower, description: 'An ancient stupa, one of the oldest in Sri Lanka.' },
    { title: 'Kande Viharaya', image: hospital, description: 'A vast monastery complex and one of the largest stupas.' },
    { title: 'Turtle Hatchery', image: seema, description: 'The Brazen Palace, a magnificent nine-storied building.' },
    { title: 'Galapata Raja Vihara', image: Red_Mosque, description: 'Known for its guard stones and ancient architecture.' },
    { title: 'Best Family-Friendly Beaches To Visit On The South Coast Of Sri Lanka', image: portcity, description: 'One of the tallest brick structures in the world.' },
  ];
