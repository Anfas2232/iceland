...
const Slideshow = ({ slides }) => {
  ...
  return (
    <div id="ArugamBayCarousel" className="carousel slide carousel-fade mb-5">
...
const ArugamBayDetailsPage = () => {
  ...
  const attractions = [
    { title: 'Elephant Rock', image: museum, description: 'Discover history and heritage.' },
    { title: 'Surf Breaks in Arugam Bay', image: tower, description: 'An ancient stupa, one of the oldest in Sri Lanka.' },
    { title: 'Pottuvil Point', image: hospital, description: 'A vast monastery complex and one of the largest stupas.' },
    { title: 'Panama Tank', image: seema, description: 'The Brazen Palace, a magnificent nine-storied building.' },
    { title: 'Kudubigala Sanctuary', image: Red_Mosque, description: 'Known for its guard stones and ancient architecture.' },
    { title: 'Crocodile Rock', image: portcity, description: 'One of the tallest brick structures in the world.' },
  ];
