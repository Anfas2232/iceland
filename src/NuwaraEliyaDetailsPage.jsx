...
const NuwaraEliyaDetailsPage = () => {
  const slides = [
    {
      image: colompo,
      title: ' Nuwara Eliya At A Glance',
  ...
  const attractions = [
    { title: 'Lovers Leap', image: museum, description: 'Discover history and heritage.' },
    { title: 'Hakgala Botanical Garden', image: tower, description: 'An ancient stupa, one of the oldest in Sri Lanka.' },
    { title: 'Gregory Lake  ', image: hospital, description: 'A vast monastery complex and one of the largest stupas.' },
    { title: 'Moon Plains', image: seema, description: 'The Brazen Palace, a magnificent nine-storied building.' },
    { title: 'Ambewela Farm', image: Red_Mosque, description: 'Known for its guard stones and ancient architecture.' },
