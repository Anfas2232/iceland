...
const Slideshow = ({ slides }) => {
  ...
  return (
    <div id="BatticaloaCarousel" className="carousel slide carousel-fade mb-5">
...
const BatticaloaDetailsPage = () => {
  const slides = [
    {
      image: colompo,
      title: 'Batti’s Multicultural Splendour',
    ...
    {
      image: seema,
      title: 'Heritage Museum of Kattankudy',
      subtitle: 'The Brazen Palace with majestic architecture.',
    },
  ];

  const attractions = [
    { title: 'Batticaloa Fort', image: museum, description: 'Discover history and heritage.' },
    { title: 'Batticaloa Lagoon', image: tower, description: 'An ancient stupa, one of the oldest in Sri Lanka.' },
    { title: 'Mahatma Gandhi Park', image: hospital, description: 'A vast monastery complex and one of the largest stupas.' },
    { title: 'Heritage Museum of Kattankudy', image: seema, description: 'The Brazen Palace, a magnificent nine-storied building.' },
    { title: 'Batticaloa Lighthouse', image: Red_Mosque, description: 'Known for its guard stones and ancient architecture.' },
    { title: 'Kallady Bridge', image: portcity, description: 'One of the tallest brick structures in the world.' },
  ];
    ...
    <div className="min-vh-100 d-flex flex-column">
      ...
      <div className="container-fluid py-2 flex-grow-1">
        <div className="main-content-column">
          ...
          >
           Batti’s Multicultural Splendour
          </h1>
