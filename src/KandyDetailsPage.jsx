...
const Slideshow = ({ slides }) => {
  ...
  return (
    <div id="KandyCarousel" className="carousel slide carousel-fade mb-5">
...
const KandyDetailsPage = () => {
  ...
  const attractions = [
    { title: 'Kandy Lake', image: museum, description: 'Discover history and heritage.' },
    { title: '3 Gardens You Must Visit in Sri Lanka', image: tower, description: 'An ancient stupa, one of the oldest in Sri Lanka.' },
    { title: 'Hulu River Waterfall', image: hospital, description: 'A vast monastery complex and one of the largest stupas.' },
    { title: ' Dalada Maligawa', image: seema, description: 'The Brazen Palace, a magnificent nine-storied building.' },
