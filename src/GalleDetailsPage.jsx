...
const Slideshow = ({ slides }) => {
  ...
  return (
    <div id="GalleCarousel" className="carousel slide carousel-fade mb-5">
...
const GalleDetailsPage = () => {
  const slides = [
    {
      image: gal1,
      title: ' The Ancient Wonders of Galle',
  ...
  const attractions = [
   { title: 'Galle Fort', image: gal1, description: 'A UNESCO World Heritage site with colonial charm.' },
    { title: 'Lighthouse', image: gal2, description: 'The famous Galle Lighthouse by the sea.' },
    { title: 'National Maritime Museum', image: gal3, description: 'Discover Sri Lanka’s naval history.' },
    { title: 'Jungle Beach', image: gal4, description: 'A hidden tropical beach with clear waters.' },
    { title: 'Unawatuna Beach', image: gal5, description: 'A lively beach with restaurants and activities.' },
    { title: 'Dutch Reformed Church', image: gal6, description: 'A historic 18th-century Dutch church.' },
  ];
